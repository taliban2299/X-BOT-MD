...
const ALIVE = process.env.ALIVE || "Professor X is active";
const HANDLERS = process.env.HANDLER || ".";
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:f325c71eb343b5c89d1d45316ceec1d9";
const SUDO = process.env.SUDO || '254115758028';
...
const BOT_INFO = process.env.BOT_INFO || "PROFESSOR X;ASWIN SPARKY;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/absolutely_sparky";
const AUDIO_DATA = process.env.AUDIO_DATA || "Professor X;ASWIN SPARKY;https://i.imgur.com/fVCRCYG.jpeg";
